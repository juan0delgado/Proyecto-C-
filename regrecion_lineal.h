...
void regresion(todo* arr, int n) {
    ...
    cout << " Desea ver los resulatdos de la regrecion lineal como:"<<endl;
    cout << " #epocas , ecuacion recta , error cuadratico ? "<<endl;
    cout << " si o no "<<endl;
    string respuesta2;
cin >> respuesta2;
